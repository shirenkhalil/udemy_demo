...
class MainMobileMyLearning extends StatefulWidget {
  ...
  const MainMobileMyLearning({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.separated(
        itemBuilder: (context,index)=> buildMyLearning(context, getCoursesListMyLearning()[index]),
        ...
        itemCount: getCoursesListMyLearning().length,
      ),
    );
  }
